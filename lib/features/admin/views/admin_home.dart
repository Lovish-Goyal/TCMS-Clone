...
class AdminHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final batchLength = batchState is BatchLoaded
    //     ? batchState.batches.length
    //     : 0;

    return Scaffold(
      appBar: myAppBar(context, title: 'SEMS Admin'),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            BottomCards(activeBatches: 3, inactiveBatches: null),
